...
# 创建topic
kafka-topics.sh --create --topic test --partitions 3 --replication-refactor 2 --zookeeper 192.168.1.120:2181
...
# 生产消息，ctrl+c结束
kafka-console-producer.sh --topic test --broker-list 1192.168.1.100:9092
